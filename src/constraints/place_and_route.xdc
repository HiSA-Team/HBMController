...
# Hierarchy is under HBM_controller_fpga_top / u_hbm_core (see HBM_controller_fpga_top.sv).
create_pblock pblock_1
add_cells_to_pblock [get_pblocks pblock_1] [get_cells  [list {u_hbm_core/genblk2[0].HBM_channel_controller_i} {u_hbm_core/genblk2[1].HBM_channel_controller_i} {u_hbm_core/genblk2[2].HBM_channel_controller_i} {u_hbm_core/genblk2[3].HBM_channel_controller_i} {u_hbm_core/genblk2[4].HBM_channel_controller_i} {u_hbm_core/genblk2[5].HBM_channel_controller_i} {u_hbm_core/genblk2[6].HBM_channel_controller_i} {u_hbm_core/genblk2[7].HBM_channel_controller_i} {u_hbm_core/u_mmcm_0}]]
resize_pblock [get_pblocks pblock_1] -add {CLOCKREGION_X0Y0:CLOCKREGION_X3Y2}
create_pblock pblock_2
add_cells_to_pblock [get_pblocks pblock_2] [get_cells  [list {u_hbm_core/genblk2[8].HBM_channel_controller_i} {u_hbm_core/genblk2[9].HBM_channel_controller_i} {u_hbm_core/genblk2[10].HBM_channel_controller_i} {u_hbm_core/genblk2[11].HBM_channel_controller_i} {u_hbm_core/genblk2[12].HBM_channel_controller_i} {u_hbm_core/genblk2[13].HBM_channel_controller_i} {u_hbm_core/genblk2[14].HBM_channel_controller_i} {u_hbm_core/genblk2[15].HBM_channel_controller_i} {u_hbm_core/u_mmcm_1} ]]
