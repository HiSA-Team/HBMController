...
module channel_scheduler (
    ...
    output logic [P_REQ_ID_CAS_RAM_WIDTH+P_BA_ADDR_WIDTH-2:0] wr_ram_cas_address_req_id_ps0,
    output logic [P_REQ_ID_CAS_RAM_WIDTH+P_BA_ADDR_WIDTH-2:0] wr_ram_cas_address_req_id_ps1,
    ...
    output logic [P_REQ_ID_CAS_RAM_WIDTH+P_BA_ADDR_WIDTH-2:0] rd_ram_cas_address_req_id_ps0,
    output logic [P_REQ_ID_CAS_RAM_WIDTH+P_BA_ADDR_WIDTH-2:0] rd_ram_cas_address_req_id_ps1,
